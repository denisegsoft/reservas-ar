    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-6">
        ...
        <form id="profileInfoForm" class="space-y-6">
            ...
            <div class="space-y-3">
                ...
                @php
                $socials = [
                    ['key' => 'social_instagram', 'label' => 'Instagram',  'base' => 'https://instagram.com/', 'placeholder' => 'https://instagram.com/usuario',
                     'color' => '#e1306c',
                    ...
                    ['key' => 'social_facebook',  'label' => 'Facebook',   'base' => 'https://facebook.com/', 'placeholder' => 'https://facebook.com/usuario',
                     'color' => '#1877f2',
                     'icon'  => '<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>'],
                    ['key' => 'social_twitter',   'label' => 'X / Twitter', 'base' => 'https://x.com/', 'placeholder' => 'https://x.com/usuario',
                     'color' => '#000000',
                    ...
                    ['key' => 'social_tiktok',    'label' => 'TikTok',     'base' => 'https://tiktok.com/@', 'placeholder' => 'https://tiktok.com/@usuario',
                     'color' => '#010101',
                    ...
                    ['key' => 'social_youtube',   'label' => 'YouTube',    'base' => 'https://youtube.com/@', 'placeholder' => 'https://youtube.com/@canal',
                     'color' => '#ff0000',
                    ...
                    ['key' => 'website',          'label' => 'Página web', 'base' => 'https://', 'placeholder' => 'https://mipagina.com',
                     'color' => '#6366f1',
...
const SERVICE_DATA = {
    whatsapp: {
        ...
        description: '¿Querés que tu negocio responda automáticamente las 24 hs o estas cansado de responder siempre las mismas preguntas? Te ayudamos a configurar un Chatbot inteligente  para tu WhatsApp Business. Además, te creamos un Sitio web propio para que tu negocio tenga presencia online.',
        benefits: [
