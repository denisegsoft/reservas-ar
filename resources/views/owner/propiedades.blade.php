...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div x-data="{ show: true }" x-show="show" x-transition.opacity
        ...
        <span class="flex-1">{{ session('success') }}
            @if(session('success_property_slug'))
                <a target="_blank" href="{{ route('properties.show', session('success_property_slug')) }}" class="ml-2 font-semibold underline hover:text-green-900 whitespace-nowrap">Ver propiedad →</a>
            @endif
        </span>
