<x-guest-layout>
    ...
    <div class="relative mb-6">
        ...
        <div class="relative flex justify-center text-xs uppercase">
            <span class="bg-white px-3 text-gray-400 font-medium tracking-wider">o registrate con email o teléfono</span>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        {{-- Login --}}
        <div>
            <label for="login" class="block text-sm font-semibold text-gray-700 mb-1.5">Email o teléfono</label>
            <input id="login" type="text" name="login" value="{{ old('login') }}"
                   required autofocus autocomplete="username" placeholder="tu@email.com  o  11-1234-5678"
