<x-guest-layout>
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-900">Nueva contrasena</h2>
        <p class="text-sm text-gray-500 mt-1">Ingresa y confirma tu nueva contrasena.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
        ...
        <div>
            <label for="password" class="block text-sm font-semibold text-gray-700 mb-1.5">Nueva contrasena</label>
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-semibold text-gray-700 mb-1.5">Confirmar contrasena</label>
            <input id="password_confirmation" type="password" name="password_confirmation"
                   required autocomplete="new-password" placeholder="Repeti tu contrasena"
