...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <form id="edit-form" action="{{ route('owner.properties.update', $propiedad) }}" method="POST" enctype="multipart/form-data" class="space-y-6" novalidate>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                ...
                <div x-data="{
                    ...
                    <input id="edit-name" type="text" name="name" value="{{ old('name', $propiedad->name) }}" required
                ...
                <div x-data="{
                    ...
                    <textarea id="edit-desc" name="description" rows="5" required
            ...
            <div class="space-y-4">
                ...
                <div x-data="addressAutocomplete('{{ $currentProvinceId }}', '{{ old('partido', $propiedad->partido) }}', '{{ old('locality', $propiedad->locality) }}')"
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <div class="flex-1">
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Calle <span class="font-normal text-gray-400 text-xs">(opcional)</span></label>
                        ...
                        <div class="sm:w-32">
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Número <span class="font-normal text-gray-400 text-xs">(opcional)</span></label>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="mt-6 border-t border-gray-100 pt-5"
                 x-data="{
                    ranges: {{ json_encode(old('blocked_ranges', $blockedRanges)) }},
