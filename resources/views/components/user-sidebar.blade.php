        ...
        <div style="display:flex;align-items:center;gap:10px">
            ...
            <div style="min-width:0;flex:1">
                <p style="color:#fff;font-size:13px;font-weight:600;
                           ...
                           margin:0;line-height:1.3">{{ $user->full_name }}</p>
    ...
    <nav style="flex:1;padding:10px 8px;display:flex;flex-direction:column;gap:18px;overflow-y:auto">
        ...
        <div>
            ...
            <div style="display:flex;flex-direction:column;gap:1px">
                ...
                {!! sidebarNavItem('Reservas recibidas', 'owner.reservations', 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2') !!}
